...
| S07 | `Setup-Level.dc.html` | Set input level against noise, live meter, headroom target | FR-CAP-3, F3 | Level slider. `Test` arms the meter. `Continue` enabled only in range | drawn + built — counter now `5 of 10` |
