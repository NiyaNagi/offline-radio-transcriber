...
| R-074 | frequencies | `Frequencies`, `Frequency`, `Frequency-Change` | List rows are frequency + count. The artboard: what it is (repeater · band · mode), tonight's count and station count, a 14-night sparkline with hatched nights, "busier than usual" in amber. Detail lacks the facts table (offset, tone, listened hours, nets), the typical-night chart, `Regulars`. `Frequency-Change` (departure vs usual, with the cause) is absent. | design | fixed |
